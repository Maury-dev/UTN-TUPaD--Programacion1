...
#10)Utilizando la información aportada en la siguiente tabla sobre las estaciones del año: Desde el 21 de diciembre hasta el 20 de marzo (incluidos) Hemisferio norte: Invierno Hemisferio sur: Verano Desde el 21 de marzo hasta el 20 de junio (incluidos) Hemisferio norte: Primavera Hemisferio sur: Otoño Desde el 21 de junio hasta el 20 de septiembre (incluidos) Hemisferio norte: Verano Hemisferio sur: Invierno,Desde el 21 de septiembre hasta el 20 de diciembre (incluidos), Hemisferio norte: Otoño, Hemisferio sur: Primavera. Escribir un programa que pregunte al usuario en cuál hemisferio se encuentra (N/S), qué mes del año es y qué día es. El programa deberá utilizar esa información para imprimir por pantalla si el usuario se encuentra en otoño, invierno, primavera o verano.
